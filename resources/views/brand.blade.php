        ...
        <div class="container-scroller">
                ...
                <div class="container">
                    <div class="row mt-5 d-flex justify-content-between align-items-center">
                        <div class="col-lg-6" style="margin-left: 40px;">
                            <h2 class="m-0">Proucts Details</h2>
                        </div>
            ...
            <script>
                ...
                function getProducts() {
                    $.ajax({
                        url: '/products/list', // or wherever you fetch the products from
                        method: 'GET',
                        ...
                        <td>
                        <button class="btn btn-warning edit-product-btn" data-bs-toggle="modal" data-bs-target="#updateProductModal" data-id="${product.id}">Edit</button>
